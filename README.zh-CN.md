...
![](https://oscimg.oschina.net/oscnet/up-57372ac2c27dcd4e44ff435eae76344511b.png)

- 一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用和零代码应用。
- 产品方向： AI应用平台与低代码结合产品，功能涵盖：AI应用平台、AI零代码应用、AI报表、AI大屏、AI仪表盘、Chat2BI报表

![](https://oscimg.oschina.net/oscnet/up-fd1191bca8a9ed82ade67d0bc6db9070588.jpg)

好的，以下是将“Chat AI报表”替换为“Chat2BI”后的文本：

---

这是一款业内领先的综合性AI应用平台，深度融合AI技术与低代码开发理念，专为企业和开发者打造智能化、自动化的业务系统构建环境。产品功能丰富，涵盖AI应用平台、零代码开发、智能报表、数据大屏、移动报表及创新的Chat2BI等多维度。
